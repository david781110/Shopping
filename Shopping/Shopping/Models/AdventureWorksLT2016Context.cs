...
namespace Shopping.Models
{
    public partial class AdventureWorksLT2016Context : DbContext
    {
        ...
        //================================= 自己設計的購物車
        public virtual DbSet<TestCart> TestCart { get; set; } = null!;
        //=================================
...
//                optionsBuilder.UseSqlServer("Server=.;Database=AdventureWorksLT2016;Trusted_Connection=True;MultipleActiveResultSets=true");
//            }
        }
